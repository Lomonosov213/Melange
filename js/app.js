...
$(document).ready(function () {
   $(window).scroll(function (event) {// слушаем скролл, т.е. внутри скобок все действия происходят только при скролле
      var s = $(this).scrollTop();// тут получаем пиксели проскролленые от верха
      var w = $(this).outerWidth(); //ширина окна
      var h = $(".sec1__content").outerHeight(); //получаем высоту блока .sec1__content
      var h_p = $(".sec1__paralax").outerHeight(); //получаем высоту блока .sec1__paralax
      var p = s / h * 100; //получаем процентное значение прокрутки? блока .sec1__content
      var p_b = s / h_p * 100; //получаем процентное значение прокрутки? блока .sec1__paralax
      var o = 1 - 1 / 250 * p_b; //переменная прозрачности
      var z_1 = 1 - (w / 500000 * p_b);

      var holeScale = $(".paralax__hole").css('transform');
      //var holeScaleval = 'matrix(1.0068, 0, 0, 1.0068, 0, 0)'


      /*
            while (holeScale != holeScaleval) {
                  $(".paralax__hole").css('transform', 'scale(' + z_1 + ')'); //находим блок .paralax__hole и изменяем ему css свойство с помощью переменной

   
           }
           */
      $(".paralax__hole").css('transform', 'scale(' + z_1 + ')'); //находим блок .paralax__hole и изменяем ему css свойство с помощью переменной
      $(".paralax__hole").css('opacity', o);
...
// вращение кругов паралакса при скроле ========================================================================================================================================================
/*
...
window.addEventListener("scroll", function () {
   circle2.style.transform = "rotate(" + window.pageYOffset * 50 + "deg)";
   circle3.style.transform = "rotate(-" + window.pageYOffset / 20 + "deg)";
   circle5.style.transform = "rotate(" + window.pageYOffset / 20 + "deg)";
});
*/
...
jQuery(function (f) {
   ...
   var element2 = f('#back-top2');
   f(window).scroll(function () {
      element['fade' + (f(this).scrollTop() > 490 ? 'In' : 'Out')](800);
      element2['fade' + (f(this).scrollTop() > 490 ? 'In' : 'Out')](800);
   });
});
*/
...
jQuery(function (f) {
   var element = f('#back-top');
   var header = f('#header1');
   var elementScroll = f('#scrolwrapp');



   f(window).scroll(function () {
      element['fade' + (f(this).scrollTop() < 600 ? 'In' : 'Out')](200);// исезновение главной
      header['fade' + (f(this).scrollTop() < 600 ? 'In' : 'Out')](200);
      // elementScroll['fade' + (f(this).scrollTop() < 200 ? 'In' : 'Out')](100); // исчезновение кнопки скролл

   });
});

// убрать иконку скролла при клике ========================================================================================================================================================
/*
$('.sec1__arrow-text').click(function () {

   if ($('.sec1__arrow-text').offset().top > 200) {
      $('.sec1__arrow').addClass("shadow");
   }
});*/
//========================================================================================================================================================

// паралакс эффект от скролла ========================================================================================================================================================
/*
$(document).ready(function () {// для паралакса нужно в html добавить к li атрибут data-depth
   //$('.parallax__list>li').addClass('layer');// или добавить вручную к тем блокам которые нужно паралаксить
   $('.sec1__block1').parallax();//добавил паралакс эффект (файл нужно подключить в арр)
   $('.paralax__body').parallax();
...
function scrollNav() {
   $('.sec1__arrow-text').click(function () {
      ...
      $('html, body').stop().animate({
         scrollTop: $($('.sec1__arrow-text').attr('href')).offset().top - 510
      }, 600);
      return false;
   });
}
